# Tabular SARSA
A tabular implementation of the SARSA reinforcement learning algorithm. This agent works by learning how to predict the expected value of every possible action in every possible environment state.
